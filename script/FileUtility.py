...
class file_util:
	...
	##
	# Get a specified column from a tab-delimited file
	##
	...
	#
	def replace_all(self,target,names):
	...
	#
	#
	def select2(self,target,names,outfile):
	...
	def help(self):
		...
		print "    select2 - similar to select, simpler and faster. NEED: i,j,o"
		...
		print " -c the column number NOTE: not index. Can specify multiple"
...
if __name__ == '__main__':
	...
	function = t_dir = ext = file1 = file2 = outfile = c = T = P = ""
	d_dir = "./"
	name  = "*"
	delim = "\t"
	F     = M = p = allT = allN = 0
	...
	if function == "copy":
		...
		if file1 == "" or file2 == "" or outfile == "":
			print "\nNeed to specify input and output files\n"
			futil.help()
		futil.select2(file1,file2,outfile)
